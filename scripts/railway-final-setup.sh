...
echo ""
echo -e "${GREEN}🗄️ DATABASE_URL (TU URL REAL):${NC}"
echo "postgresql://postgres:password@postgres-production-0e37.up.railway.app:5432/railway"
echo ""
...
echo "- Settings → Variables → Pegar variables de arriba"
echo "- NO se necesita añadir servicio PostgreSQL (ya existe)"
echo ""
